...
const workspaceInstall = `
    ...
    <head>
      ...
      <title>Install: Upgrade App Sample</title>
      <style>
        ${css}
      </style>
    </head>
    <body>
      <div>
      <h1>📈 Install the app on your workspace! This means you can send and approve invites, but you cannot disconnect shared channels!</h1>
      <h3><i>This will install the base version of the app<i><h3>
...
module.exports = workspaceInstall;
